 ...
 * culori.
 */
import { simulateCVD, contrastRatio, deltaE2000, type CVDType } from "../../src/color";
import {
...
export function simulateForConvention(hex: string, cvd: CVDType, convention: SimulationConvention): string {
...
export function referenceCrossChecks(): { name: string; ok: boolean; detail: string }[] {
